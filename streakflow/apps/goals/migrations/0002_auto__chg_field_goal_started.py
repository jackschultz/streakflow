...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Goal.started'
        db.alter_column(u'goals_goal', 'started', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Goal.started'
        db.alter_column(u'goals_goal', 'started', self.gf('django.db.models.fields.DateTimeField')())
