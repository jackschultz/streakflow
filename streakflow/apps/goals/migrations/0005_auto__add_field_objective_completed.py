...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Objective.completed'
        db.add_column(u'goals_objective', 'completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Objective.completed'
        db.delete_column(u'goals_objective', 'completed')
