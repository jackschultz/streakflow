...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimeFrame.end_time'
        db.alter_column(u'goals_timeframe', 'end_time', self.gf('django.db.models.fields.DateField')())

        # Changing field 'TimeFrame.begin_time'
        db.alter_column(u'goals_timeframe', 'begin_time', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'TimeFrame.end_time'
        db.alter_column(u'goals_timeframe', 'end_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'TimeFrame.begin_time'
        db.alter_column(u'goals_timeframe', 'begin_time', self.gf('django.db.models.fields.DateTimeField')())
